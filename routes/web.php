...
//  nouveau truc ajouter

// Route::get('/home', function () {
//     $cart = session()->get('cart', []);
//     $cartCount = array_sum(array_column($cart, 'quantity'));
//     return view('catalogue', compact('cartCount'));
// });
...
Route::get('/produits', function () {
    $cart = session()->get('cart', []);
    $cartCount = array_sum(array_column($cart, 'quantity'));
    return view('produits', compact('cartCount'));
});
...
Route::get('/nouveautés', function () {
    $cart = session()->get('cart', []);
    $cartCount = array_sum(array_column($cart, 'quantity'));
    return view('nouveautés', compact('cartCount'));
});

Route::get('/panier', function () {
    $cart = session()->get('cart', []);
    $cartCount = array_sum(array_column($cart, 'quantity'));
    return view('panier', compact('cartCount'));
});
